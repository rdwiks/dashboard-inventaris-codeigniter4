                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <?php if (in_groups('admin')) : ?>
                                    <div class="nav-kategori">
                                        <!-- Add Product-->
                                        <a href="<?= site_url('transaksi/pengeluaran/create') ?>" class="btn btn-sm btn-dark "><span class="bi bi-plus-circle"> Tambah</span></a>
                                    </div><!-- End Add Product -->
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($transaksi as $p) : ?>
                                    <tr>
                                        ...
                                        <?php if (in_groups('admin')) : ?>
                                            <td>
                                                <a href="<?= site_url('transaksi/pengeluaran/edit/' . $p->id_pengeluaran); ?>" class="btn btn-success btn-sm bi bi-pencil-square" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"></a>
                                                <form action="<?= site_url('transaksi/pengeluaran/delete/' . $p->id_pengeluaran); ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>
