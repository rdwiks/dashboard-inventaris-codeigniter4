            ...
            <div class="card border-top border-primary border-5">
                <div class="card-body">
                    ...
                    <?php foreach ($transaksi as $p) : ?>
                        <form action="<?= site_url('transaksi/pengeluaran/update/' . $p->id_pengeluaran) ?>" class="needs-validation row g-3 pt-4" method="post" enctype="multipart/form-data" accept-charset="utf-8" novalidate>
                            <?= csrf_field() ?>
                            ...
                            <div class="row col-sm-6 mb-3 position-relative">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="keterangan" value="<?= (old('keterangan')) ? old('keterangan') : $p->keterangan; ?>" class="form-control <?= $error = validation_Errors('keterangan') ? 'is-invalid' : ''; ?>" required>
                                    <div class="invalid-tooltip">
                            ...
                            <div class="row col-sm-6 mb-3 position-relative">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="kategori" value="<?= (old('kategori')) ? old('kategori') : $p->kategori; ?>" class="form-control <?= $error = validation_Errors('kategori') ? 'is-invalid' : ''; ?>" required>
                                    <div class="invalid-tooltip">
