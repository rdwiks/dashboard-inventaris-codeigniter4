    ...
    <div class="row">
        <div class="col-12 mt-2">
            <div class="card recent-sales overflow-auto border-top border-primary border-5">
                <div class="card-body">
                    <h5 class="card-title" style="font-weight: bold; font-size: 20px;">Daftar Transaksi</h5>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <?php if (in_groups('admin')) : ?>
                                    <div class="nav-kategori">
                                        <!-- Add Product-->
                                        <a href="<?= site_url('transaksi/pembelian/create') ?>" class="btn btn-sm btn-dark "><span class="bi bi-plus-circle"> Tambah</span></a>
                                    </div><!-- End Add Product -->
                                <?php endif; ?>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($transaksi as $p) : ?>
                                    <tr>
                                        ...
                                        <td><?= $p->supplier; ?></td>
                                        <td><?= $p->nama_barang; ?></td>
                                        <td><span class="badge text-bg-secondary"><?= $p->jumlah; ?></span></td>
                                        <td><span class="badge " style="background-color: tomato;"><?= $p->harga; ?></span></td>
                                        <?php if (in_groups('admin')) : ?>
                                            <td>
                                                <a href="<?= site_url('transaksi/pembelian/edit/' . $p->id_pembelian); ?>" class="btn btn-success btn-sm bi bi-pencil-square" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"></a>
                                                <form action="<?= site_url('transaksi/pembelian/delete/' . $p->id_pembelian); ?>" method="post" class="d-inline">
                                                    <?= csrf_field(); ?>
