...
<section class="section">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#"></a>Asset</li>
    ...
    <div class=" col-md-12 mt-2">
        <div class="card recent-sales overflow-auto border-top border-primary border-5">
            <div class="card-body">
                <h5 class="card-title" style="font-weight: bold; font-size: 20px;">Daftar Lokasi</h5>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <?php if (in_groups('admin')) : ?>
                                <div class="nav-kategori">
                                    <!-- Add Product-->
                                    <a href="<?= site_url('assets/kategori/create') ?>" class="btn btn-sm btn-dark"><span class="bi bi-plus-circle"> Tambah</span></a>
                                </div><!-- End Add Product -->
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="font-size:small; width:100%;">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($kategori as $p) : ?>
                                <tr>
                                    <th scope="row"><?= $i++; ?></th>
                                    <td><span class="badge text-bg-<?= ($p['kode_kategori'] == 'A') ? 'warning' : 'danger'; ?>"><?= $p['kode_kategori']; ?></span></td>
                                    <td><?= $p['nama_kategori']; ?></td>
                                    <?php if (in_groups('admin')) : ?>
                                        <td>
                                            <a href="<?= site_url('assets/kategori/edit/' . $p['id_kategori']); ?>" class="btn btn-success btn-sm bi bi-pencil-square" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"></a>
                                            <form action="<?= site_url('assets/kategori/delete/' . $p['id_kategori']); ?>" method="post" class="d-inline">
                                                <?= csrf_field(); ?>
