        ...
        <div class="col-lg-6 mt-2">
            <div class="card border-top border-primary border-5">
                <div class="card-body">
                    ...
                    <form action="<?= site_url('assets/kategori/update/' . $kategori['id_kategori']); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="kode_kategori" value="<?= (old('kode_kategori')) ? old('kode_kategori') : $kategori['kode_kategori']; ?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="nama_kategori" value="<?= (old('nama_kategori')) ? old('nama_kategori') : $kategori['nama_kategori']; ?>" class="form-control">
                            </div>
                        </div>
