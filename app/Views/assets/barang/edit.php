    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= site_url('kategori'); ?>"> Barang</a></li>
        ...
        <div class="col-lg-6 mt-2">
            <div class="card border-top border-primary border-5">
                <div class="card-body">
                    ...
                    <form action="<?= site_url('assets/barang/update/' . $barang['id_barang']); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <?= csrf_field() ?>
                        <input type="hidden" name="_method" value="PUT">
                        <div class="row mb-3">
                            <label for="kode_barang" class="col-sm-4 col-form-label">Kode Barang</label>
                            <div class="col-sm-8">
                                <input type="text" name="kode_barang" value="<?= (old('kode_barang')) ? old('kode_barang') : $barang['kode_barang']; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="nama_barang" class="col-sm-4 col-form-label">Nama Barang</label>
                            <div class="col-sm-8">
                                <input type="text" name="nama_barang" value="<?= (old('nama_barang')) ? old('nama_barang') : $barang['nama_barang']; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-10">
