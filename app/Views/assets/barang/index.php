...
<section class="section">
    ...
    <div class=" col-md-12 mt-4">
        <div class="card recent-sales overflow-auto border-top border-primary border-5">
            <div class="card-body">
                <h5 class="card-title" style="font-weight: bold; font-size: 20px;">Daftar Barang</h5>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <?php if (in_groups('admin')) : ?>
                                <div class="nav-kategori">
                                    <!-- Add Product-->
                                    <a href="<?= site_url('assets/barang/create') ?>" class="btn btn-sm btn-dark "><span class="bi bi-plus-circle"> Tambah</span></a>
                                </div><!-- End Add Product -->
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $p) : ?>
                                <tr>
                                    <th scope="row"><?= $i++; ?></th>
                                    <td><?= $p['kode_barang']; ?></td>
                                    <td><span class="badge"></span><?= $p['nama_barang']; ?></td>
                                    <?php if (in_groups('admin')) : ?>
                                        <td>
                                            <a href="<?= site_url('assets/barang/edit/' . $p['id_barang']); ?>" class="btn btn-success btn-sm bi bi-pencil-square" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"></a>
                                            <form action="<?= site_url('assets/barang/delete/' . $p['id_barang']); ?>" method="post" class="d-inline">
                                                <?= csrf_field(); ?>
